...
API will response the users and their activity similar to the user requested in the API call along with their similarity distance. API response object will be as follows:
